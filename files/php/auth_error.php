<?php 
	// LOAD: include $_SERVER["DOCUMENT_ROOT"]."/files/php/auth_error.php";
	echo '<html> <head> ';
	if ($auth > 0) {
	...
	echo '<link rel="shortcut icon" href="/files/images/error_favicon.png"> <link rel="stylesheet" type="text/css" href="/files/css/errors.css"> </head> <body>';
	if ($auth > 0) {
	...
	if ($auth > 0) {
		...
		echo "<p><a href='/account/login/".$returnLink."'>Login</a></p>";
	}
